...
/**
 Event sent when the chatbot menu has expired. After receiving
 this event, this menu should be considered inactive. All messages sent through
 this object will be ignored.
 
 @param menu The associated chatbot menu.
 */
